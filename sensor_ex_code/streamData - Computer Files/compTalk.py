  ...
  def __init__(self, host='None'):
    ...
    if (host == 'None'):
      try:
        ...
        print("error - unable to obtain an address")
        sys.exit()

    temp = host.split('.')

    if (temp[0] != "192") and (temp[1] != "168"):
      print('The network you are connected to is not a Pi')
      sys.exit()

    print('Attempting to connect to Pi ', temp[2],' using ', host)
    try:
